 ...
 * @aside guide forms
 *
 * This is a specialized field which shows a {@link Commutalize.util.DateTimePicker} when tapped. If it has a predefined value,
 * or a value is selected in the {@link Commutalize.util.DateTimePicker}, it will be displayed like a normal {@link Ext.field.Text}
 * (but not selectable/changable).
 *
 *     Ext.create('Commutalize.util.DateTimePickerField', {
 *         label: 'Birthday',
 *         value: new Date()
 *     });
 *
 * {@link Commutalize.util.DateTimePickerField} fields are very simple to implement, and have no required configurations.
 *
 * ## Examples
 *
 * It can be very useful to set a default {@link #value} configuration on {@link Commutalize.util.DateTimePickerField} fields. In
 ...
 *     });
 *
 * When you need to retrieve the date from the {@link Commutalize.util.DateTimePickerField}, you can either use the {@link #getValue} or
...
Ext.define('Commutalize.util.DateTimePickerField', {
     ...
     * @param {Commutalize.util.DateTimePickerField} this
    ...
    config: {
        ...
        /**
         * @cfg {Object/Commutalize.util.DateTimePicker} picker
         * An object that is used when creating the internal {@link Commutalize.util.DateTimePicker} component or a direct instance of {@link Commutalize.util.DateTimePicker}
         * Defaults to true
         * @accessor
         */
        picker: true,
         ...
         * Default value for the field and the internal {@link Commutalize.util.DateTimePicker} component. Accepts an object of 'year',
    ...
    updateValue: function(newValue) {
        ...
        if (this._picker && this._picker instanceof Commutalize.util.DateTimePicker) {
    ...
    updateDateFormat: function(newDateFormat, oldDateFormat) {
        ...
        if (newDateFormat != oldDateFormat && Ext.isDate(value) && this._picker && this._picker instanceof Commutalize.util.DateTimePicker) {
    ...
    getPicker: function() {
        ...
        if (picker && !picker.isPicker) {
            picker = Ext.factory(picker, Commutalize.util.DateTimePicker);
            picker.on({
                scope: this,
     ...
     * @param {Commutalize.util.DateTimePicker} picker The date picker
     ...
     * {@link Commutalize.util.DateTimePickerField#destroyPickerOnHide destroyPickerOnHide} is set to true
     * @private
     */
     ...
     * @inheritdoc Commutalize.util.DateTimePickerField#getPicker
